...
//mobile resources
if (x.matches){
  loader.add('notebook','images/elem-notebook/elem-notebookBM.png');
  loader.add('seruling','images/elem-seruling/elem-SerulingBM.png');
  loader.add('headdress','images/elem-headpiece/elem-HEADDRESS-BM.png');
  loader.add('phone','images/elem-phone/elem-phoneBM.png');
}
