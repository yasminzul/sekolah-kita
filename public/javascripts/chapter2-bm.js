...
let textArr = [
`<div class="chtitle">Sekolah-sekolah Kita</div>`,

`(Umur 2-4)
<div class="chtitle">Taska KEMAS</div>
 Pendidikan awal dan perkhidmatan penjagaan harian kanak-kanak untuk ibu bapa bekerjaya yang mempunyai anak-anak kecil, memenuhi keperluan masyarakat luar bandar. Di bawah bidang kuasa Kementerian Pembangunan Luar Bandar.
 <div class="chcounter">1/19</div>`,

`(Umur 4-6)
<div class="chtitle">Tabika KEMAS</div>
 Kelas prasekolah yang menyediakan kanak-kanak sebelum ke sekolah rendah, memenuhi keperluan masyarakat luar bandar. Terdapat 268 Tabika di perkampungan Orang Asli dan kawasan pedalaman. Di bawah bidang kuasa Kementerian Pembangunan Luar Bandar.
...
Sekolah rendah yang dikendalikan oleh kerajaan, di mana bahasa pengantarnya adalah Bahasa Malaysia
<div class="chcounter">4/19</div>`,

`(Umur 7-12)
<div class="chtitle">Sekolah Jenis Kebangsaan</div>
 Sekolah rendah vernakular, di mana bahasa pengantarnya dalam Bahasa Mandarin atau Tamil.
 <div class="chcounter">5/19</div>`,

`(Umur 7-12)
<div class="chtitle">Sekolah Kebangsaan Orang Asli</div>
 Sekolah rendah kerajaan yang terletak di dalam atau berhampiran populasi utama Orang Asli. Murid di sekolah-sekolah ini majoritinya kaum Orang Asli. Sehingga 2018, terdapat 94 sekolah seperti ini.
 <div class="chcounter">6/19</div>`,

`(Umur 7-15)
<div class="chtitle">Sekolah Model Khas Komprehensif K9</div>
 Sekolah yang terletak berhampiran populasi Orang Asli yang besar di kawasan pedalaman, di mana pelajar dikehendaki melengkapkan sukatan pelajaran sembilan tahun, daripada Darjah 1 hingga Tingkatan 3. Sekolah ini diwujudkan untuk menangani kadar keciciran yang tinggi dalam kalangan pelajar Orang Asli apabila beralih dari sekolah rendah ke sekolah menengah, dengan mengadakan peralihan itu dalam sekolah yang sama. Pada masa ini terdapat lima sekolah K9 di Semenanjung Malaysia, dan 11 lagi di Sabah dan Sarawak yang memenuhi keperluan penduduk Orang Asal di sana.
 <div class="chcounter">7/19</div>`,

`(Umur 7-17)
<div class="chtitle">Sekolah Pendidikan Khas</div>
 Sekolah rendah dan menengah untuk kanak-kanak istimewa.
 <div class="chcounter">8/19</div>`,

`(Umur 13-17)
<div class="chtitle">Sekolah Menengah Kebangsaan</div>
Sekolah menengah yang dikendalikan oleh kerajaan, di mana bahasa pengantarnya adalah Bahasa Malaysia
<div class="chcounter">9/19</div>`,

`
<div class="chtitle">Sekolah Menengah Jenis Kebangsaan</div>
 Sekolah menengah vernakular, di mana bahasa pengantarnya dalam bahasa Mandarin. Tiada sekolah menengah berbahasa Tamil.
 <div class="chcounter">10/19</div>`,
`
<div class="chtitle">Sekolah Berasrama Penuh</div>
 Sekolah Berasrama untuk pelajar Malaysia berpencapaian tinggi, tumpuan kepada mata pelajaran sains dan teknologi. Terdapat 69 sekolah sedemikian.
 <div class="chcounter">11/19</div>`,

`
<div class="chtitle">Pusat Intelek Pelajar Orang Asli (PIPOA)</div>
 Sekolah khas untuk pelajar Orang Asli berpencapaian tinggi, untuk Tingkatan 1 hingga 3. Terdapat hanya sebuah sekolah PIPOA iaitu di Rompin, Pahang.
 <div class="chcounter">12/19</div>`,

`
<div class="chtitle">Sekolah Agama</div>
 Terdapat sekolah agama Islam di peringkat rendah dan menengah.
 <div class="chcounter">13/19</div>`,

`
<div class="chtitle">Sekolah Menengah Teknik</div>
 Sekolah menengah vokasional dengan tumpuan utama terhadap pendidikan berasaskan kemahiran dan amalan industri.
 <div class="chcounter">14/19</div>`,

`
<div class="chtitle">Sekolah Seni / Sekolah Sukan</div>
 Sekolah yang menyediakan perkhidmatan kepada pelajar yang cemerlang dalam bidang seni atau sukan.
 <div class="chcounter">15/19</div>`,

`(Umur 18 ke atas)
<div class="chtitle">Pengajian Tinggi</div>
Ramai murid Orang Asli mengimpikan pendidikan yang lebih tinggi, tetapi sering terpaksa bergantung kepada biasiswa atau program bantuan, malah untuk mendaftar di universiti kerajaan bersubsidi.
<div class="chcounter">16/19</div>`,

`(Umur dewasa)
<div class="chtitle">Kelas Dewasa Ibu Bapa Orang Asli Dan Penan (KEDAP)</div>
 Kelas literasi dewasa untuk Orang Asli, diadakan di sekolah. Orang dewasa yang mendaftar kelas KEDAP diberi elaun untuk hadir.
...
`<div class="chtitle">Sekolah swasta</div>
 Terdapat institut pendidikan swasta untuk semua peringkat pendidikan. Ia terdiri daripada sekolah berbayar yang mahal, kepada institusi tanpa-keuntungan yang memenuhi keperluan komuniti terpinggir, dan juga program pembelajaran di rumah.
 <div class="chcounter">19/19</div>`,

`<div class="chtitle finished">Anda telah menamatkan bab ini!</div>
  <button id="start-again" class="ch-startover">BERMULA SEKALI LAGI</button>`,
]
